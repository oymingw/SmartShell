...
import util.IBeaconUtils;


@SuppressLint("ParcelCreator")
public class IBeaconDevice extends BluetoothDeviceExtend implements BeaconDevice {
    ...
    /**
     * Will try to convert a {@link BluetoothDeviceExtend} into an
     * iBeacon Device.
     *
     * @param device the device
     * @throws IllegalArgumentException if the passed device is not an iBeacon
     */
    public IBeaconDevice(final BluetoothDeviceExtend device) {
        super(device);
        mIBeaconData = new IBeaconManufacturerData(this);
    }
