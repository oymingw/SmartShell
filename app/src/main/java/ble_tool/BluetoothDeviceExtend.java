...
import resolvers.BluetoothClassResolver;
...
import adrecord.AdRecordStore;
import adrecord.AdRecordUtils;
import containers.BeaconDevice;
import containers.BeaconType;
import containers.BeaconUtils;
import containers.IBeaconDevice;
import util.ByteUtils;
import util.LimitedLinkHashMap;
 ...
 */
public class BluetoothDeviceExtend implements Parcelable , BeaconDevice {
    /**
     * The Constant CREATOR.
     */
    public static final Creator<BluetoothDeviceExtend> CREATOR = new Creator<BluetoothDeviceExtend>() {
        public BluetoothDeviceExtend createFromParcel(final Parcel in) {
            return new BluetoothDeviceExtend(in);
        }

        public BluetoothDeviceExtend[] newArray(final int size) {
     ...
     */
    public BluetoothDeviceExtend(final BluetoothDevice device, final int rssi, final byte[] scanRecord, final long timestamp) {
        mDevice = device;
        mFirstRssi = rssi;
     ...
     */
    public BluetoothDeviceExtend(final BluetoothDeviceExtend device) {
    ...
    protected BluetoothDeviceExtend(final Parcel in) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        final BluetoothDeviceExtend other = (BluetoothDeviceExtend) obj;
