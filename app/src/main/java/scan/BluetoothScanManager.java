...
import scan.bluetoothcompat.ScanFilterCompat;
import scan.bluetoothcompat.ScanResultCompat;
import scan.bluetoothcompat.ScanSettingsCompat;
 ...
 * <li>当前扫描状态</li>
 * </ol>
 * 注意：回调不在主线程中执行，需要自己在主线程中处理回调（{@link scan.ScanOverListener} and {@link scan.bluetoothcompat.ScanCallbackCompat}）,
